      ...
      >
        <div>
          ...
          <p style={{ fontSize: '1rem', lineHeight: 1.6, color: '#333' }}>
            Create your student account to access timed assessments, track your scores, and receive instant results.
          </p>
        </div>
        ...
        <div style={{ maxWidth: '420px', width: '100%' }}>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
              Register as a student to take assessments.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            {/* Full name */}
            <div>
              <label style={{ display: 'block', fontWeight: 700, marginBottom: '8px', fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                Full Name
              </label>
